<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pwd-change.aspx.cs" Inherits="Lakshmi_Groceries.pwd_change" %>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="width:80%;">
                        <div class="signin-container">
                                <p class="form-row">
                                    ...
                                    <asp:TextBox runat="server" class="txt-input" id="userMail_C" name="email" required="required" TextMode="Email"></asp:TextBox>
                                </p>
                                <p class="form-row">
                                    <label for="fid-pass">Old Password<span class="requite">*</span></label> 
                                    <asp:TextBox runat="server" class="txt-input" id="oldPwd_C" name="oldpwd" required="required" TextMode="Password"></asp:TextBox>
                                </p>
                                <p class="form-row">
                                    <label for="fid-pass">New Password<span class="requite">*</span></label> 
                                    <asp:TextBox runat="server" class="txt-input" id="newPwd_C" name="newpwd" required="required" TextMode="Password"></asp:TextBox>
                                    <asp:RegularExpressionValidator runat="server" ID="regexValidator_RP" 
                                            ControlToValidate="NewPwd_C" 
                                ...
                                <p class="form-row">
                                    ...
                                    <asp:TextBox runat="server" class="txt-input" id="conPwd_C" name="cpwd" required="required" TextMode="Password"></asp:TextBox>
                                    <asp:CompareValidator 
                                            ID="cvConfirmPassword_C" 
                                            runat="server" 
                                            ControlToValidate="conPwd_C" 
                                            Operator="Equal" 
                                            ControlToCompare="newPwd_C" 
                                            ErrorMessage="Passwords not matched" ForeColor="#006600" />
                                </p>
                                <p class="form-row wrap-btn">
                                    <asp:Button runat="server" class="btn btn-submit btn-bold" ID="submiBtn_C" Text="Submit" type="submit" ForeColor="White" OnClick="submiBtn_C_Click"></asp:Button>
                                </p>
                        </div>
                    </div>
                </div>
