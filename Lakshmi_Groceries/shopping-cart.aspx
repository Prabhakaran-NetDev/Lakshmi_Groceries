<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shopping-cart.aspx.cs" Inherits="Lakshmi_Groceries.shopping_cart" %>
                ...
                <div class="col-lg-9 col-md-8 padding-top-2px">
                    <div class="header-search-bar layout-01">
                        <asp:Panel runat="server" action="#" class="form-search" name="desktop-seacrh" method="get">
                            ...
                            <asp:ImageButton runat="server" class="btn-submit" ImageUrl="~/assets/images/search-icon.png" ImageAlign="Bottom" ID="BtnWebSearch" Width="80px" Height="38" Style="padding: 2px;" OnClick="BtnWebSearch_Click" UseSubmitBehavior="False"></asp:ImageButton>
                        </asp:Panel>
                    </div>
                    <div class="live-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 sm-padding-top-48px sm-margin-bottom-0 xs-margin-bottom-15px">
                           <div class="order-summary sm-margin-bottom-80px">
                               ...
                               <asp:TextBox ID="CartValue" runat="server" PlaceHolder="Product seriel Number"></asp:TextBox>
                                    ...
                                    <ul class="subtotal">
                                        ...
                                        <li>
                                            <div class="subtotal-line">
                                                ...
                                                <asp:Button ID="BtnCheckOut" CssClass="btn bg-info" runat="server" Text="Do CheckOut" OnClick="BtnCheckOut_Click" UseSubmitBehavior="False" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
