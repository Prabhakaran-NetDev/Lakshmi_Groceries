<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product-list.aspx.cs" Inherits="Lakshmi_Groceries.product_list" %>
...
<body class="biolife-body">
    ...
    <div class="hero-section hero-background">
        <h1 class="page-title">Shoping page</h1>
    </div>
            ...
            <div class="row">
                ...
                <div id="main-content" class="main-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="product-category grid-style">
                                ...
                                <div class="wrap-selectors">
                                    <asp:Panel runat="server">
                                        ...
                                        <div class="selector-item">
                                            <asp:DropDownList ID="CategoryFilter" runat="server" class="selector">
                                                <asp:ListItem Text="Category" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Fruits"></asp:ListItem>
                                                <asp:ListItem Text="Vegetables"></asp:ListItem>
                                                <asp:ListItem Text="Nuts & Dry Fruits"></asp:ListItem>
                                                <asp:ListItem Text="Grains"></asp:ListItem>
                                                <asp:ListItem Text="Flours"></asp:ListItem>
                                                <asp:ListItem Text="Milk Products"></asp:ListItem>
                                                <asp:ListItem Text="Fresh Meat"></asp:ListItem>
                                                <asp:ListItem Text="Ocean Foods"></asp:ListItem>
                                                <asp:ListItem Text="Packed Foods"></asp:ListItem>
                                                <asp:ListItem Text="Drinks"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="selector-item">
                                            <asp:DropDownList ID="PrizeFilter" runat="server" class="selector">
                                                <asp:ListItem Text="Prize" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Less than ₹50"></asp:ListItem>
                                                <asp:ListItem Text="₹50-100"></asp:ListItem>
                                                <asp:ListItem Text="₹100-500"></asp:ListItem>
                                                <asp:ListItem Text="₹500-1000"></asp:ListItem>
                                                <asp:ListItem Text="₹1000-2000"></asp:ListItem>
                                                <asp:ListItem Text="₹2000-5000"></asp:ListItem>
                                                <asp:ListItem Text="More than ₹5000"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="selector-item">
                                            <asp:DropDownList ID="BrandFilter" runat="server" class="selector">
                                                <asp:ListItem Text="Brands" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Brand1"></asp:ListItem>
                                                <asp:ListItem Text="Brand2"></asp:ListItem>
                                                <asp:ListItem Text="Brand3"></asp:ListItem>
                                                <asp:ListItem Text="Brand4"></asp:ListItem>
                                                <asp:ListItem Text="Brand5"></asp:ListItem>
                                                <asp:ListItem Text="Brand6"></asp:ListItem>
                                                <asp:ListItem Text="Brand7"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <span class="flt-title">
                                            <asp:Button ID="BtnFilter" OnClick="BtnFilter_Click" runat="server" Text="Apply" style="border:0;background:none;" Font-Size="Larger" CausesValidation="False" />
                                        </span>
                                    </asp:Panel>
                                </div>
                            </div>
                            <div class="flt-item to-right">
                                ...
                                <div class="wrap-selectors">
                                    <div class="selector-item orderby-selector">
                                        <asp:DropDownList ID="Sorting" OnSelectedIndexChanged="Sorting_select" runat="server" class="orderby" AutoPostBack="true">
                                            <asp:ListItem Text="Default" Selected="True"></asp:ListItem>
                                            <asp:ListItem Text="popularity"></asp:ListItem>
                                            <asp:ListItem Text="prize: low to high"></asp:ListItem>
                                            <asp:ListItem Text="prize: high to low"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <ul class="products-list" id="panelMaster" runat="server">
                        ...
                        <section class="footer-item">
                            ...
                            <div class="newsletter-block layout-01">
                                ...
                                <div class="form-content">
                                    <asp:Panel runat="server" name="new-letter-foter">
