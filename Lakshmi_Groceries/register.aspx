<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Lakshmi_Groceries.register" %>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="width:80%;">
                        <div class="signin-container">
                            <p class="form-row">
                                ...
                                <asp:TextBox runat="server" class="txt-input" id="userName_R" name="name" required="required" ></asp:TextBox>
                                <asp:RegularExpressionValidator runat="server" ID="regexValidator_RU" 
                                        ControlToValidate="userName_R" 
                                        ErrorMessage="Username length should be 3 to 20 characters" 
                                        ValidationExpression="\w{3,20}" ForeColor="#006600" />
                            </p>
                            <p class="form-row">
                                <label for="fid-pass">Email Address<span class="requite">*</span></label> 
                                <asp:TextBox runat="server" class="txt-input" id="userMail_R" name="email" required="required" TextMode="Email"></asp:TextBox>
                                <asp:RegularExpressionValidator runat="server" ID="regexValidator_RE" 
                                        ControlToValidate="userMail_R" 
                            ...
                            <p class="form-row">
                                ...
                                <asp:TextBox runat="server" class="txt-input" id="pwd_R" name="pwd" required="required" TextMode="Password"></asp:TextBox>
                                <asp:RegularExpressionValidator runat="server" ID="regexValidator_RP" 
                                        ControlToValidate="pwd_R" 
                            ...
                            <p class="form-row">
                                ...
                                <asp:TextBox runat="server" class="txt-input" id="conPwd_R" name="cpwd" required="required" TextMode="Password"></asp:TextBox>
                                <asp:CompareValidator 
                                        ID="cvConfirmPassword_R" 
                                        runat="server" 
                                        ControlToValidate="conPwd_R" 
                                        Operator="Equal" 
                                        ControlToCompare="pwd_R" 
                                        ErrorMessage="Passwords not matched" ForeColor="#006600" />
                            </p>
                            <p class="form-row wrap-btn">
                                <asp:Button runat="server" class="btn btn-submit btn-bold" ID="submiBtn_R" Text="Register" type="submit" ForeColor="White" OnClick="submiBtn_R_Click"></asp:Button>
                            </p> 
                        </div>
                    </div>
                </div>
