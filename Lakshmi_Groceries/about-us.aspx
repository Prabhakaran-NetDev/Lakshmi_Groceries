<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about-us.aspx.cs" Inherits="Lakshmi_Groceries.about_us" %>
    ...
    <div class="page-contain about-us">
        ...
        <div id="main-content" class="main-content">
            ...
            <div class="welcome-us-block">
                <div class="container">
                    <h4 class="title">Welcome to Lakshmi Groceries!</h4>
                    <div class="text-wraper">
                        <p class="text-info">At Lakshmi Groceries, we're passionate about providing our community with the freshest produce, 
                                                highest-quality meats, and widest selection of products at affordable prices. Our family-owned business 
                                                has been serving for years, building relationships with local farmers, 
                                                suppliers, and customers alike. We're committed to making grocery shopping a pleasant experience, 
                                                with friendly staff, clean stores, and a commitmen to excellence in everything we do. Whether 
                                                you're a long-time resident or new to the area, we invite you to visit us and discover why we're 
                                                go-to grocery destination for families, foodies, and anyone seeking a superior shopping experience.</p>
                        <p class="qt-text">"Fresh provisions for a healthy life, quality goods for a happy home."</p>
                    </div>
                </div>
            </div>
