<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Review.aspx.cs" Inherits="Lakshmi_Groceries.Review" %>
...
<body class="biolife-body">
    ...
    <div class="page-contain">
        <div id="main-content" class="main-content">
            <input type="button" onclick="Orders()" value="Orders" class="btn btn-success" style="background-color:#003135;margin-left:100px;"/>
            <input type="button" onclick="Products()" value="Products" class="btn btn-success" style="background-color:#003135;"/>
            <div class="container" id="Order_Con" style="background-color:#2fadb7">
                <div class="row">
                    <div class="col-12 col-lg-7">
                        <asp:GridView ID="OrdersGrid" runat="server" Width="600px" Height="600px" AutoGenerateColumns="False" ForeColor="Black" Style="margin:30px;border-color:#003135;border-width:5px;" OnRowCommand="OrdersBox_Click">
                            <Columns>
                                <asp:BoundField DataField="order_id" HeaderText="Order ID" SortExpression="order_id" ></asp:BoundField>
                            ...
                            <Columns>
                                <asp:ButtonField ButtonType="Button" Text="Update" HeaderText="Update" ControlStyle-CssClass="btn btn-primary" CommandName="UpdateClick" />
                                <asp:ButtonField ButtonType="Button" Text="Delete" HeaderText="Delete" ControlStyle-CssClass="btn btn-danger" CommandName="DeleteClick" />
                            </Columns>
                        </asp:GridView>
                    </div>
                    <div class="col col-lg-5" style="margin-top:30px;">
                        <asp:Label ID="Label1" runat="server" Text="Status" style="background-color:#2a9ca0;padding-inline:200px;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:DropDownList ID="Order_status" style="padding-left:30px;" runat="server" Width="120px" BackColor="#F6F1DB" ForeColor="#7d6754" Font-Names="Andalus" >
                            <asp:Listitem Text="Delivered" Selected="True"></asp:Listitem>
            ...
            <div class="container" id="Product_Con" style="background-color:#2fadb7;overflow-x:scroll;" hidden="hidden" >
                <div style="margin-top:30px;">
                    <div class="form-group col-lg-4">
                        <asp:Label ID="Label2" runat="server" Text="Name" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Name" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label3" runat="server" Text="Description" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Description" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label4" runat="server" Text="Prize" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Prize" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label5" runat="server" Text="Status" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                    ...
                    <div class="form-group col-lg-4">
                        <asp:Label ID="Label6" runat="server" Text="Image" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label7" runat="server" Text="Orginal Prize" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Orginal_Prize" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label8" runat="server" Text="Title" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Title" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Button ID="UploadButton" runat="server" OnClick="UploadButton_Click" Text="Upload" CssClass="btn btn-secondary"/>
                    </div>
                    <div class="form-group col-lg-4">
                        <asp:Label ID="Label11" runat="server" Text="Product ID" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Product_id" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="Label10" runat="server" Text="Category ID" style="display:block;background-color:#2a9ca0;color:aliceblue;border:solid;"></asp:Label>
                        <br />
                        <asp:TextBox ID="Category_id" runat="server" class="form-control"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Button ID="products_categories" runat="server" OnClick="Define_Category_Click" Text="Define Category" CssClass="btn btn-secondary"/>                    
                    </div>
                </div>                
                <div class="row">
                    <div class="col-lg-9">
                        <asp:GridView ID="ProductsGrid" runat="server" Width="600px" Height="600px" AutoGenerateColumns="False" ForeColor="Black" Style="margin:30px;border-color:#003135;border-width:5px;" OnRowCommand="BtnDeleteImage_Click">
                            <Columns>
                                <asp:BoundField DataField="product_id" HeaderText="Order ID" SortExpression="order_id" ></asp:BoundField>
                                <asp:BoundField DataField="product_name" HeaderText="Product Name" SortExpression="product_name"></asp:BoundField>
                                <asp:BoundField DataField="product_description" HeaderText="Product Name" SortExpression="product_name"></asp:BoundField>
                                <asp:BoundField DataField="product_price" HeaderText="Product Price" SortExpression="product_price"></asp:BoundField>
                                <asp:BoundField DataField="product_status" HeaderText="Product Name" SortExpression="product_name"></asp:BoundField>
                                <asp:BoundField DataField="product_img" HeaderText="Product Name" SortExpression="product_name"></asp:BoundField>
                                <asp:BoundField DataField="product_org_price" HeaderText="Quantity" SortExpression="quantity"></asp:BoundField>
                                <asp:BoundField DataField="product_title" HeaderText="Status" SortExpression="status"></asp:BoundField>
                            </Columns>
                            <Columns>
                                <asp:ButtonField ButtonType="Button" Text="Delete" HeaderText="Delete" ControlStyle-CssClass="btn btn-danger" CommandName="DeleteClick" />
                            </Columns>
                ...
                <asp:GridView ID="categoryGrid" runat="server" Width="600px" Height="600px" AutoGenerateColumns="False" ForeColor="Black" Style="margin:30px;border-color:#003135;border-width:5px;" OnRowCommand="OrdersBox_Click">
                    <Columns>
                        <asp:BoundField DataField="category_id" HeaderText="Order ID" SortExpression="order_id" ></asp:BoundField>
                        <asp:BoundField DataField="category_Name" HeaderText="Product Name" SortExpression="product_name"></asp:BoundField>
                        <asp:BoundField DataField="category_description" HeaderText="Product Name" SortExpression="product_name"></asp:BoundField>
                    </Columns>   
                </asp:GridView>
            </div>
            </div>
        ...
        <script>
            function Orders() {
                const btn1 = document.getElementById('Order_Con');
                const btn2 = document.getElementById('Product_Con');
                btn1.hidden = false;
                btn2.hidden=true;
            }
            function Products() {
