<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Lakshmi_Groceries.login" %>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="signin-container">
                            <p class="form-row">
                                ...
                                <asp:TextBox runat="server" class="txt-input" id="userMail_L" name="email" required="required" TextMode="Email" Font-Size="15px"></asp:TextBox>
                            </p>
                            <p class="form-row">
                                <label for="fid-pass">Password<span class="requite">*</span></label> 
                                <asp:TextBox runat="server" class="txt-input" id="pwd_L" name="pwd" required="required" TextMode="Password" Font-Size="15px"></asp:TextBox>
                            </p>
                            <p class="form-row wrap-btn">
                                <asp:Button runat="server" class="btn btn-submit btn-bold" ID="submiBtn_L" Text="sign in" ForeColor="White" OnClick="submiBtn_L_Click"></asp:Button>
                                <a href="forgot-pwd.aspx" class="link-to-help" style="margin-left: 50px;margin-top: 10px;">Forgot your password</a>
                                <a href="pwd-change.aspx" class="link-to-help" style="margin-left: 50px;margin-top: 10px;">Change password</a> 
                            </p>
                            <br />
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            <asp:CheckBox ID="CheckBox1" runat="server" Text="&nbsp Admin Signup" style="font-size:medium;font-family:Cambria;"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="register-in-container">
                            <div class="intro">
                                ...
                                <a href="register.aspx" class="btn btn-bold">Create an account</a>
                            </div>
                        </div>
                    </div>
