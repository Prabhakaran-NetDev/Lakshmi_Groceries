<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Lakshmi_Groceries.contact" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="contact-info-container sm-margin-top-27px xs-margin-bottom-60px xs-margin-top-60px">
                            ...
                            <p class="frst-desc">At Lakshmi Groceries, we're passionate about providing our community with the freshest produce, 
                                                highest-quality meats, and widest selection of products at affordable prices. Our family-owned business 
                                                has been serving for years.</p>
                            <ul class="addr-info">
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Addess:</b>
                                        <p class="dsc">1111 XX. XXXXXXXXXX, XXXXXXXXXXXXXXXXX<br/>XXXXXXXXXXXX, XX</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Phone:</b>
                                        <p class="dsc">8888888888</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Email:</b>
                                        <p class="dsc">lakshmigroceries@company.com</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Store Open:</b>
                                        <p class="dsc">8Am - 8Pm, Mon - Sat</p>
                                    </div>
                                </li>
                            </ul>
